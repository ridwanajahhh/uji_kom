    ...
    <div class="row">
        ...
        <main class="col-md-10 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div>
                    <a href="{{ route('admin.toko.show', $toko->id_toko) }}" class="btn btn-info me-2">
                ...
                <div class="col-lg-8">
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-warning text-dark">
                            <h5 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Form Edit Toko</h5>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.toko.update', $toko->id_toko) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')

                                @if(auth()->user()->role === 'admin')
                                <div class="mb-3">
                                    <label for="id_user" class="form-label">Pemilik Toko <span class="text-danger">*</span></label>
                                    <select class="form-select @error('id_user') is-invalid @enderror" id="id_user" name="id_user" required>
                                        ...
                                        @foreach($users as $u)
                                            <option value="{{ $u->id_user }}" {{ old('id_user', $toko->id_user) == $u->id_user ? 'selected' : '' }}>
                                                {{ $u->nama }} ({{ $u->username }})
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('kontak_toko') is-invalid @enderror" id="kontak_toko" name="kontak_toko" value="{{ old('kontak_toko', $toko->kontak_toko) }}" placeholder="081234567890">
                                        @error('kontak_toko')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" value="{{ old('alamat', $toko->alamat) }}" placeholder="Jl. Contoh No. 123, Kota">
                                        @error('alamat')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">
                                        ...
                                        @if($toko->gambar)
                                            <strong>Gambar saat ini akan diganti jika Anda memilih gambar baru.</strong>
                                        @endif
                                    </div>
                                    @error('gambar')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="border rounded p-2">
                                        <img src="{{ asset('storage/assets/' . $toko->gambar) }}" class="img-fluid rounded" alt="Gambar Toko" style="max-height: 200px;">
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-warning">
                                        <i class="bi bi-check-circle me-1"></i>Update Toko
                                    </button>
                                    <a href="{{ route('admin.toko.index') }}" class="btn btn-secondary">
